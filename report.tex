...
\ifnum 0\ifxetexhttps://www.overleaf.com/project/5f16ff9676f8960001f1b13a 1\fi\ifluatex 1\fi=0 % if pdftex
...
possible programming flaws. We use PMD for two tasks: %to generate 
%alerts that we interpret as clues about kludges and to create an
%AST from the source code with selected kinds of node.
...
%
% MARCIO: o comentário acima foi feito por você ou para você? Deixe claro
% e coloque o comentário como footnote.
%
...
%
% MARCIO: tem como tirar o cinza claro do segundo conjunto de AST? E tem como 
% colocar as quatro na mesma página para facilitar a leitura? Ou você poderia
% apresentar apenas um par de AST e escrever ao lado os textos associados aos
% nós que você destacou no segundo conjunto de AST. Eu prefiro esta última,
% pois o documento ficaria um pouco menor e menos redundante.
%
...
%
% MARCIO: o gráfico acima parece ter uma margem gigante abaixo. 
% Veja a distância entre as árvores e a legenda. Pode cortar isso?
%
...
%
% MARCIO: nós não vimos esta relação entre linhas. Isto é relevante?
%
...
%
% MARCIO: mesmo comentário feito acima sobre a borda inferior do desenho.
%
...
%
% MARCIO: mas porque esta path é importante? Explica! E o gráfico da path
% não está bom ... os números nos nós e seus textos estão todos misturados.
% Sobra espaço na direita e na esquerda, mas as informações no centro estão
% muito comprimidas. Melhora isso, por favor.
%
